...
class ms_errs(_object):
    ...
    ERR_MSP_HTTP_WININET_FAILED = _msparser.ms_errs_ERR_MSP_HTTP_WININET_FAILED
...
class ms_mascotresfile(_object):
    __swig_setmethods__ = {}
    ...
    def isValid(self): return _msparser.ms_mascotresfile_isValid(self)
    def getNumberOfErrors(self): return _msparser.ms_mascotresfile_getNumberOfErrors(self)
    def clearAllErrors(self): return _msparser.ms_mascotresfile_clearAllErrors(self)
